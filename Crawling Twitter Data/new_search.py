...
tweets = tweepy.Cursor(api.search_tweets,
                       q="#covid OR covid-19 geocode:-37.840935,144.946457,2000km",
                       lang="en").items(10)
...
# tweet.user.location will give you the general location of the user and not the particular location for the tweet
# itself, as it turns out, most of the users do not share the exact location of the tweet
