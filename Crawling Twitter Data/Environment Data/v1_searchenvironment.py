...
class listener(tw.Stream):
    ...
    def on_data(self, data):
        ...
        with open('twitterdata_environment.json', 'a', encoding='utf-8') as tf:
...
if __name__ == '__main__':
    ...
    try:
        ...
        stream.filter(languages=['en'], track=['co2', 'carbon dioxide', 'pollution', 'air pollution', 'air quality', 'environmental pollution', 'mountain fire', 'vehicle emission', 'greenspace', 'toxic waste', 'plastic pollution', 'ozone', 'ozone layer'], locations=[144.312,-38.506,145.894,-37.160])
